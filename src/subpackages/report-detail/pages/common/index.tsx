...
export default function Index() {
  ...
  // 权限控制 是否可以查看该报告
  const [canViewReport, setCanViewReport] = useState(true);
  const [errMsg, setErrMsg] = useState('您没有权限查看该报告');
  ...
  useDidShow(() => {
    ...
    checkLoginStatus().then((res) => {
      if (res) {
        ...
        Taro.navigateTo({
          url: `/pages/login/index?redirect=/subpackages/report-detail/pages/common/index?type=${type}&reportId=${reportId}`,
        });
      }
    });
  });
  ...
  return (
    <View className='h-screen flex flex-col items-center bg-transparent'>
      ...
      <View
        ...
        <View
          className='w-full px-3 pb-6 watermark-container'
          ...
          {canViewReport ? (
            <>
              <View className='mb-5 h-72'>
                {reportFullInfo?.detail.scoreStatistics?.detail?.length && (
                  <RadarChart
                    ...
                    fullScore={
                      reportFullInfo.detail.scoreStatistics.totalPoints
                    }
                    type={type}
                  />
                )}
              ...
              {reportFullInfo?.detailSummary && (
                <ModuleCard title='报告概况' type={type}>
                  ...
                  <View
                    ...
                    <Text
                      className={cls('mb-1 before-dot', `before-dot-${type}`)}>
                      报告一共解读
              ...
              {reportDetail?.identity && (
                <ModuleCard
                  ...
                  divide
                  imageUrl={
                    INFO_CHECK_STATUS[reportDetail.identity.checkStatus]
                  }
                  type={type}>
                  ...
                  {reportDetail.identity.checkStatus ===
                    STATUS_MAP.ABNORMAL && (
              ...
              {reportDetail?.matrimonyStatus && (
                <ModuleCard
                  ...
                  {reportDetail.matrimonyStatus.checkStatus ===
                    STATUS_MAP.MARRIED && (
                    <Text className='error-text'>已婚</Text>
                  )}
              ...
              {reportDetail?.defective && (
                <ModuleCard
                  ...
                  divide
                  imageUrl={
                    RECORD_CHECK_STATUS[reportDetail.defective.checkStatus]
                  }
                  type={type}>
                  ...
                  {reportDetail.defective.checkStatus ===
                    STATUS_MAP.ABNORMAL && (
              ...
              {reportDetail?.deadbeat && (
                <ModuleCard
                  ...
                  divide
                  imageUrl={
                    RECORD_CHECK_STATUS[reportDetail.deadbeat.checkStatus]
                  }
                  type={type}>
                  ...
                  {reportDetail.deadbeat.checkStatus ===
                    STATUS_MAP.ABNORMAL && (
                    <Text className='error-text'>有异常</Text>
                  )}
              ...
              {reportDetail?.loanRecords && (
                <ModuleCard
                  ...
                  {reportDetail.loanRecords.checkStatus ===
                    STATUS_MAP.NORMAL && (
                    <Text className={cls('success-text', COLOR_MAP.textColor)}>
                      未见异常
                    </Text>
              ...
              {reportDetail?.promise && (
                <ModuleCard
                  ...
                  divide
                  imageUrl={
                    RECORD_CHECK_STATUS[reportDetail.promise.checkStatus]
                  }
                  type={type}>
              ...
              {reportDetail?.network && (
                <ModuleCard
                  ...
                  divide
                  imageUrl={
                    RECORD_CHECK_STATUS[reportDetail.network.checkStatus]
                  }
                  type={type}>
              ...
              {reportDetail?.careerCheck && (
                <ModuleCard
                  ...
                  {reportDetail.careerCheck.checkStatus ===
                    STATUS_MAP.FALSE && <Text className='error-text'>否</Text>}
            ...
            <View className='flex-center flex-col h-full'>
              <EmptyStatus title={errMsg} icon={empty} />
              <AtButton
                type='primary'
                className='w-1/2 py-2 mb-4 h-9 rounded-3xl'
                onClick={() => Taro.switchTab({ url: '/pages/home/index' })}>
                <View className='text-sm font-medium flex items-center h-full'>
                  回到首页
                </View>
              </AtButton>
            </View>
      ...
      {canViewReport && <WaterMark text={reportFullInfo?.watermark} />}
    </View>
  );
}
